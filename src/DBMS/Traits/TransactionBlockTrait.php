...
trait TransactionBlockTrait
{
	...
	public function begin()
	{
		if ($this->getBlockState() !=
			TransactionBlockInterface::STATE_UNDEFINED)
			throw new \LogicException(
				__METHOD__ . ' called probably twice');
	...
	{
		if ($this->getBlockState() ==
			TransactionBlockInterface::STATE_ROLLED_BACK)
		...
		$this->propagateBlockState(
			TransactionBlockInterface::STATE_COMMITTED);
	}
